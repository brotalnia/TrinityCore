...
enum OpcodeClient : uint16
{
    ...
    CMSG_ACCEPT_LEVEL_GRANT                                         = 0x34F9,
    ...
    CMSG_BATTLE_PAY_QUERY_CLASS_TRIAL_BOOST_RESULT                  = 0x36C1,
    CMSG_BATTLE_PAY_REQUEST_CHARACTER_BOOST_UNREVOKE                = 0x36BF,
    CMSG_BATTLE_PAY_REQUEST_CURRENT_VAS_TRANSFER_QUEUES             = 0x370B,
    CMSG_BATTLE_PAY_REQUEST_PRICE_INFO                              = 0x370A,
    CMSG_BATTLE_PAY_REQUEST_VAS_CHARACTER_QUEUE_TIME                = 0x370C,
    CMSG_BATTLE_PAY_START_PURCHASE                                  = 0x36F0,
    CMSG_BATTLE_PAY_START_VAS_PURCHASE                              = 0x36F1,
    CMSG_BATTLE_PAY_VALIDATE_BNET_VAS_TRANSFER                      = 0x370D,
    CMSG_BATTLE_PAY_VAS_PURCHASE_COMPLETE                           = 0x36EF,
    ...
    CMSG_BUY_WOW_TOKEN_CONFIRM                                      = 0x36E9,
    CMSG_BUY_WOW_TOKEN_START                                        = 0x36E8,
    CMSG_CALENDAR_ADD_EVENT                                         = 0x367B,
    CMSG_CALENDAR_COMMUNITY_FILTER                                  = 0x366F,
    CMSG_CALENDAR_COMPLAIN                                          = 0x3677,
    CMSG_CALENDAR_COPY_EVENT                                        = 0x3676,
    CMSG_CALENDAR_EVENT_INVITE                                      = 0x3670,
    CMSG_CALENDAR_EVENT_MODERATOR_STATUS                            = 0x3674,
    CMSG_CALENDAR_EVENT_RSVP                                        = 0x3672,
    CMSG_CALENDAR_EVENT_SIGN_UP                                     = 0x3679,
    CMSG_CALENDAR_EVENT_STATUS                                      = 0x3673,
    ...
    CMSG_CAN_REDEEM_WOW_TOKEN_FOR_BALANCE                           = 0x3709,
    ...
    CMSG_CHAR_RACE_OR_FACTION_CHANGE                                = 0x3693,
    ...
    CMSG_CHECK_RAF_EMAIL_ENABLED                                    = 0x36C9,
    CMSG_CHECK_WOW_TOKEN_VETERAN_ELIGIBILITY                        = 0x36E7,
    ...
    CMSG_GET_REMAINING_GAME_TIME                                    = 0x36EA,
    CMSG_GET_TROPHY_LIST                                            = 0x32FF,
    CMSG_GET_UNDELETE_CHARACTER_COOLDOWN_STATUS                     = 0x36DD,
    CMSG_GM_TICKET_ACKNOWLEDGE_SURVEY                               = 0x3691,
    CMSG_GM_TICKET_GET_CASE_STATUS                                  = 0x3690,
    CMSG_GM_TICKET_GET_SYSTEM_STATUS                                = 0x368F,
    CMSG_GOSSIP_SELECT_OPTION                                       = 0x3494,
    CMSG_GRANT_LEVEL                                                = 0x34F7,
    ...
    CMSG_GUILD_ROSTER_SEND_SO_R                                     = 0x308C,
    ...
    CMSG_INSPECT                                                    = 0x352A,
    CMSG_INSPECT_HONOR_DATA_REQUEST                                 = 0x317D,
    ...
    CMSG_LOW_LEVEL_RAID1_                                           = 0x369E,
    CMSG_LOW_LEVEL_RAID2_                                           = 0x3514,
    ...
    CMSG_OFFER_PETITION                                             = 0x36AE,
    CMSG_OPEN_ITEM                                                  = 0x331E,
    CMSG_OPEN_MISSION_NPC                                           = 0x32E3,
    ...
    CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT                      = 0x3224,
    ...
    CMSG_QUERY_COMMUNITY_NAME                                       = 0x3689,
    ...
    CMSG_QUERY_TREASURE_PICKER                                      = 0x333C,
    CMSG_QUEST_CLOSE_RELATED                                        = 0x354A,
    ...
    CMSG_RAID_OR_BATTLEGROUND_ENGINE_SURVEY                         = 0x36E2,
    CMSG_RANDOM_ROLL                                                = 0x3653,
    CMSG_READ_ITEM                                                  = 0x331F,
    CMSG_READY_CHECK_RESPONSE                                       = 0x3634,
    CMSG_RECLAIM_CORPSE                                             = 0x34DB,
    CMSG_REDEEM_WOW_TOKEN_CONFIRM                                   = 0x36EC,
    CMSG_REDEEM_WOW_TOKEN_START                                     = 0x36EB,
    CMSG_REORDER_CHARACTERS                                         = 0x35E9,
    CMSG_REMOVE_NEW_ITEM                                            = 0x333E,
    ...
    CMSG_REPORT_SERVER_LAG                                          = 0x337F,
    CMSG_REQUEST_ACCOUNT_DATA                                       = 0x3694,
    CMSG_REQUEST_AREA_POI_UPDATE                                    = 0x333D,
    CMSG_REQUEST_BATTLEFIELD_STATUS                                 = 0x35DC,
    CMSG_REQUEST_CATEGORY_COOLDOWNS                                 = 0x3180,
    ...
    CMSG_REQUEST_INSPECT_HONOR_DATA                                 = 0x36A0,
    ...
    CMSG_REQUEST_VEHICLE_EXIT                                       = 0x3236,
    CMSG_REQUEST_VEHICLE_NEXT_SEAT                                  = 0x3238,
    CMSG_REQUEST_VEHICLE_PREV_SEAT                                  = 0x3237,
    CMSG_REQUEST_VEHICLE_SWITCH_SEAT                                = 0x3239,
    CMSG_REQUEST_WOW_TOKEN_MARKET_PRICE                             = 0x36E4,
    ...
    CMSG_RIDE_VEHICLE_INTERACT                                      = 0x323A,
    ...
    CMSG_SELL_WOW_TOKEN_CONFIRM                                     = 0x36E6,
    CMSG_SELL_WOW_TOKEN_START                                       = 0x36E5,
    CMSG_SEND_CONTACT_LIST                                          = 0x36CC,
    CMSG_SEND_MAIL                                                  = 0x35FA,
    CMSG_SEND_SOR_REQUEST_VIA_ADDRESS                               = 0x3620,
    CMSG_SEND_TEXT_EMOTE                                            = 0x3488,
    CMSG_SET_ACHIEVEMENTS_HIDDEN                                    = 0x3226,
    CMSG_SET_ACTION_BUTTON                                          = 0x355A,
    ...
    CMSG_SET_GAME_EVENT_DEBUG_VIEW_STATE                            = 0x31BC,
    CMSG_SET_INSERT_ITEMS_LEFT_TO_RIGHT                             = 0x3322,
    ...
    CMSG_SET_USING_PARTY_GARRISON                                   = 0x32E5,
    ...
    CMSG_TOTEM_DESTROYED                                            = 0x34FA,
    CMSG_TRADE_SKILL_SET_FAVORITE                                   = 0x333B,
    ...
    CMSG_TWITTER_POST                                               = 0x3323,
    CMSG_UI_TIME_REQUEST                                            = 0x3699,
    ...
    CMSG_UPDATE_VAS_PURCHASE_STATES                                 = 0x36F2,
    CMSG_UPDATE_WOW_TOKEN_AUCTIONABLE_LIST                          = 0x36ED,
    CMSG_UPDATE_WOW_TOKEN_COUNT                                     = 0x36E3,
    ...
    // Opcodes that aren't found in 1.13.6
    ...
    CMSG_BATTLENET_REQUEST_REALM_LIST_TICKET                        = 0xBADD,
    CMSG_BATTLE_PAY_CANCEL_OPEN_CHECKOUT                            = 0xBADD,
    CMSG_BATTLE_PAY_TRIAL_BOOST_CHARACTER                           = 0xBADD,
    ...
    CMSG_CLUB_INVITE                                                = 0xBADD,
    CMSG_COLLECTION_ITEM_SET_FAVORITE                               = 0xBADD,
    CMSG_CONVERT_CONSUMPTION_TIME                                   = 0xBADD,
    ...
    CMSG_QUICK_JOIN_AUTO_ACCEPT_REQUESTS                            = 0xBADD,
    CMSG_RECRUIT_A_FRIEND                                           = 0xBADD,
    CMSG_REQUEST_CONSUMPTION_CONVERSION_INFO                        = 0xBADD,
    CMSG_REQUEST_GUILD_PARTY_STATE                                  = 0xBADD,
    CMSG_REQUEST_GUILD_REWARDS_LIST                                 = 0xBADD,
    CMSG_REQUEST_PVP_BRAWL_INFO                                     = 0xBADD,
    CMSG_REQUEST_RATED_BATTLEFIELD_INFO                             = 0xBADD,
    CMSG_REQUEST_WORLD_QUEST_UPDATE                                 = 0xBADD,
...
enum OpcodeServer : uint16
{
    ...
    SMSG_ACCOUNT_DATA_TIMES                                         = 0x2751,
    ...
    SMSG_ADD_LOSS_OF_CONTROL                                        = 0x269A,
    ...
    SMSG_AREA_TRIGGER_DENIED                                        = 0x26A1,
    SMSG_AREA_TRIGGER_FORCE_SET_POSITION_AND_FACING                 = 0x26A2,
    SMSG_AREA_TRIGGER_NO_CORPSE                                     = 0x275D,
    SMSG_AREA_TRIGGER_PLAY_VISUAL_EVENT                             = 0x263E,
    SMSG_AREA_TRIGGER_RE_PATH                                       = 0x2641,
    SMSG_AREA_TRIGGER_RE_SHAPE                                      = 0x263D,
    SMSG_AREA_TRIGGER_SET_VISUAL_ANIM                               = 0x263F,
    SMSG_AREA_TRIGGER_UNATTACH                                      = 0x2640,
    SMSG_ARENA_CROWD_CONTROL_SPELLS                                 = 0x264F,
    SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS                        = 0x2666,
    SMSG_ARTIFACT_FORGE_ERROR                                       = 0x27EF,
    SMSG_ARTIFACT_FORGE_OPENED                                      = 0x27ED,
    SMSG_ARTIFACT_RESPEC_CONFIRM                                    = 0x27F0,
    SMSG_ARTIFACT_TRAITS_REFUNDED                                   = 0x27F1,
    SMSG_ATTACK_START                                               = 0x266E,
    SMSG_ATTACK_STOP                                                = 0x266F,
    SMSG_ATTACK_SWING_ERROR                                         = 0x273B,
    SMSG_ATTACK_SWING_LANDED_LOG                                    = 0x273C,
    SMSG_ATTACKER_STATE_UPDATE                                      = 0x27DA,
    ...
    SMSG_AZERITE_EMPOWERED_ITEM_RESPEC_OPEN                         = 0x283C,
    SMSG_BAN_REASON                                                 = 0x26B7,
    SMSG_BARBER_SHOP_RESULT                                         = 0x26F0,
    SMSG_BATCH_PRESENCE_SUBSCRIPTION                                = 0x28A3,
    ...
    SMSG_BATTLE_PAY_DELIVERY_ENDED                                  = 0x27C7,
    SMSG_BATTLE_PAY_DELIVERY_STARTED                                = 0x27C3,
    SMSG_BATTLE_PAY_DISTRIBUTION_UPDATE                             = 0x27C2,
    SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE                  = 0x27C0,
    SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE                       = 0x27BE,
    SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE                      = 0x27BF,
    SMSG_BATTLE_PAY_MOUNT_DELIVERED                                 = 0x27C4,
    SMSG_BATTLE_PAY_OPEN_CHECKOUT_RESULT                            = 0x2866,
    SMSG_BATTLE_PAY_PURCHASE_UPDATE                                 = 0x27CF,
    SMSG_BATTLE_PAY_START_CHECKOUT                                  = 0x286C,
    SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE    = 0x27CD,
    SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE                         = 0x27CC,
    SMSG_BATTLE_PAY_SUBSCRIPTION_CHANGED                            = 0x286F,
    SMSG_BATTLE_PAY_TOY_DELIVERED                                   = 0x27C6,
    SMSG_BATTLE_PAY_VAS_BNET_TRANSFER_VALIDATION_RESULT             = 0x2864,
    SMSG_BATTLE_PAY_VAS_BOOST_CONSUMED                              = 0x27C1,
    SMSG_BATTLE_PAY_VAS_CHARACTER_LIST                              = 0x2835,
    SMSG_BATTLE_PAY_VAS_CHARACTER_QUEUE_STATUS                      = 0x285F,
    SMSG_BATTLE_PAY_VAS_PURCHASE_COMPLETE                           = 0x2838,
    SMSG_BATTLE_PAY_VAS_PURCHASE_LIST                               = 0x2839,
    SMSG_BATTLE_PAY_VAS_PURCHASE_STARTED                            = 0x2837,
    SMSG_BATTLE_PAY_VAS_REALM_LIST                                  = 0x2836,
    ...
    SMSG_BATTLEGROUND_INIT                                          = 0x27A8,
    SMSG_BATTLEGROUND_PLAYER_JOINED                                 = 0x2598,
    SMSG_BATTLEGROUND_PLAYER_LEFT                                   = 0x2599,
    SMSG_BATTLEGROUND_PLAYER_POSITIONS                              = 0x2595,
    SMSG_BATTLEGROUND_POINTS                                        = 0x27A7,
    SMSG_BATTLENET_CHALLENGE_ABORT                                  = 0x27D9,
    SMSG_BATTLENET_CHALLENGE_START                                  = 0x27D8,
    ...
    SMSG_BATTLENET_UPDATE_SESSION_KEY                               = 0x286D,
    SMSG_BIND_POINT_UPDATE                                          = 0x257C,
    SMSG_BINDER_CONFIRM                                             = 0x2741,
    ...
    SMSG_CACHE_INFO                                                 = 0x274B,
    SMSG_CACHE_VERSION                                              = 0x274A,
    ...
    SMSG_CHANGE_PLAYER_DIFFICULTY_RESULT                            = 0x273D,
    ...
    SMSG_CHAR_FACTION_CHANGE_RESULT                                 = 0x27F5,
    SMSG_CHARACTER_CLASS_TRIAL_CREATE                               = 0x280B,
    SMSG_CHARACTER_INVENTORY_OVERFLOW_WARNING                       = 0x286E,
    SMSG_CHARACTER_ITEM_FIXUP                                       = 0x285A,
    SMSG_CHARACTER_LOGIN_FAILED                                     = 0x274C,
    SMSG_CHARACTER_OBJECT_TEST_RESPONSE                             = 0x27D7,
    SMSG_CHARACTER_RENAME_RESULT                                    = 0x27B0,
    SMSG_CHARACTER_UPGRADE_COMPLETE                                 = 0x280A,
    SMSG_CHARACTER_UPGRADE_QUEUED                                   = 0x2809,
    SMSG_CHARACTER_UPGRADE_SPELL_TIER_SET                           = 0x25F5,
    SMSG_CHARACTER_UPGRADE_STARTED                                  = 0x2808,
    SMSG_CHARACTER_UPGRADE_UNREVOKE_RESULT                          = 0x280C,
    SMSG_CHAT                                                       = 0x2BAD,
    ...
    SMSG_CHAT_PLAYER_NOT_FOUND                                      = 0x2BB7,
    ...
    SMSG_CLEAR_LOSS_OF_CONTROL                                      = 0x269C,
    SMSG_CLEAR_SPELL_CHARGES                                        = 0x2C28,
    SMSG_CLEAR_TARGET                                               = 0x26E3,
    SMSG_CLOSE_ARTIFACT_FORGE                                       = 0x27EE,
    SMSG_COIN_REMOVED                                               = 0x262C,
    SMSG_COMBAT_EVENT_FAILED                                        = 0x2670,
    SMSG_COMMENTATOR_MAP_INFO                                       = 0x274E,
    SMSG_COMMENTATOR_PLAYER_INFO                                    = 0x274F,
    SMSG_COMMENTATOR_STATE_CHANGED                                  = 0x274D,
    SMSG_COMPLAINT_RESULT                                           = 0x26DA,
    SMSG_COMPLETE_SHIPMENT_RESPONSE                                 = 0x27E9,
    SMSG_CONQUEST_FORMULA_CONSTANTS                                 = 0x27D2,
    SMSG_CONSOLE_WRITE                                              = 0x2652,
    SMSG_CONTACT_LIST                                               = 0x27D5,
    SMSG_CONTRIBUTION_COLLECTOR_STATE                               = 0x2865,
    SMSG_CONTROL_UPDATE                                             = 0x2665,
    SMSG_COOLDOWN_CHEAT                                             = 0x2782,
    SMSG_COOLDOWN_EVENT                                             = 0x26EB,
    SMSG_CORPSE_LOCATION                                            = 0x266C,
    SMSG_CORPSE_RECLAIM_DELAY                                       = 0x2795,
    SMSG_CORPSE_TRANSPORT_QUERY                                     = 0x2759,
    SMSG_CREATE_CHAR                                                = 0x2746,
    SMSG_CREATE_SHIPMENT_RESPONSE                                   = 0x27E8,
    ...
    SMSG_EXPLORATION_EXPERIENCE                                     = 0x27AD,
    ...
    SMSG_FORCE_ANIM                                                 = 0x279C,
    SMSG_FORCE_OBJECT_RELINK                                        = 0x2668,
    SMSG_FORCED_DEATH_UPDATE                                        = 0x270F,
    SMSG_FRIEND_STATUS                                              = 0x27D6,
    SMSG_GAME_EVENT_DEBUG_INITIALIZE                                = 0x267E,
    SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT                              = 0x25D6,
    SMSG_GAME_OBJECT_CUSTOM_ANIM                                    = 0x25D7,
    SMSG_GAME_OBJECT_DESPAWN                                        = 0x25D8,
    SMSG_GAME_OBJECT_MULTI_TRANSITION                               = 0x2874,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL                              = 0x2C4B,
    SMSG_GAME_OBJECT_PLAY_SPELL_VISUAL_KIT                          = 0x2C4A,
    SMSG_GAME_OBJECT_RESET_STATE                                    = 0x2764,
    SMSG_GAME_OBJECT_SET_STATE                                      = 0x2848,
    SMSG_GAME_OBJECT_UI_ACTION                                      = 0x2761,
    SMSG_GAME_SPEED_SET                                             = 0x26AF,
    SMSG_GAME_TIME_SET                                              = 0x2753,
    SMSG_GAME_TIME_UPDATE                                           = 0x2752,
    SMSG_GENERATE_RANDOM_CHARACTER_NAME_RESULT                      = 0x2583,
    SMSG_GET_ACCOUNT_CHARACTER_LIST_RESULT                          = 0x27AE,
    SMSG_GET_SHIPMENT_INFO_RESPONSE                                 = 0x27E6,
    SMSG_GET_SHIPMENTS_OF_TYPE_RESPONSE                             = 0x27EA,
    SMSG_GET_TROPHY_LIST_RESPONSE                                   = 0x280F,
    ...
    SMSG_INIT_WORLD_STATES                                          = 0x2792,
    SMSG_INITIAL_SETUP                                              = 0x257F,
    SMSG_INITIALIZE_FACTIONS                                        = 0x276C,
    SMSG_INSPECT_HONOR_STATS                                        = 0x25B2,
    SMSG_INSPECT_RESULT                                             = 0x264E,
    SMSG_INSTANCE_ENCOUNTER_CHANGE_PRIORITY                         = 0x27FB,
    SMSG_INSTANCE_ENCOUNTER_DISENGAGE_UNIT                          = 0x27FA,
    SMSG_INSTANCE_ENCOUNTER_END                                     = 0x2803,
    SMSG_INSTANCE_ENCOUNTER_ENGAGE_UNIT                             = 0x27F9,
    SMSG_INSTANCE_ENCOUNTER_GAIN_COMBAT_RESURRECTION_CHARGE         = 0x2805,
    SMSG_INSTANCE_ENCOUNTER_IN_COMBAT_RESURRECTION                  = 0x2804,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_COMPLETE                      = 0x27FE,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_START                         = 0x27FD,
    SMSG_INSTANCE_ENCOUNTER_OBJECTIVE_UPDATE                        = 0x2802,
    SMSG_INSTANCE_ENCOUNTER_PHASE_SHIFT_CHANGED                     = 0x2806,
    SMSG_INSTANCE_ENCOUNTER_SET_ALLOWING_RELEASE                    = 0x2801,
    SMSG_INSTANCE_ENCOUNTER_SET_SUPPRESSING_RELEASE                 = 0x2800,
    SMSG_INSTANCE_ENCOUNTER_START                                   = 0x27FF,
    SMSG_INSTANCE_ENCOUNTER_TIMER_START                             = 0x27FC,
    SMSG_INSTANCE_GROUP_SIZE_CHANGED                                = 0x273E,
    ...
    SMSG_INVALID_PROMOTION_CODE                                     = 0x279D,
    ...
    SMSG_ISLAND_AZERITE_XP_GAIN                                     = 0x27AA,
    SMSG_ISLAND_COMPLETED                                           = 0x27AB,
    SMSG_ISLAND_OPEN_QUEUE_NPC                                      = 0x283D,
    SMSG_ITEM_CHANGED                                               = 0x2729,
    SMSG_ITEM_COOLDOWN                                              = 0x2812,
    SMSG_ITEM_ENCHANT_TIME_UPDATE                                   = 0x279F,
    SMSG_ITEM_EXPIRE_PURCHASE_REFUND                                = 0x25B1,
    SMSG_ITEM_PURCHASE_REFUND_RESULT                                = 0x25AF,
    SMSG_ITEM_PUSH_RESULT                                           = 0x2638,
    SMSG_ITEM_TIME_UPDATE                                           = 0x279E,
    SMSG_KICK_REASON                                                = 0x2834,
    ...
    SMSG_LIVE_REGION_ACCOUNT_RESTORE_RESULT                         = 0x27BC,
    SMSG_LIVE_REGION_CHARACTER_COPY_RESULT                          = 0x27BA,
    SMSG_LIVE_REGION_GET_ACCOUNT_CHARACTER_LIST_RESULT              = 0x27AF,
    SMSG_LOAD_CUF_PROFILES                                          = 0x25CE,
    SMSG_LOAD_EQUIPMENT_SET                                         = 0x2755,
    SMSG_LOAD_SELECTED_TROPHY_RESULT                                = 0x2810,
    SMSG_LOG_XP_GAIN                                                = 0x2724,
    SMSG_LOGIN_SET_TIME_SPEED                                       = 0x2754,
    ...
    SMSG_LOOT_LEGACY_RULES_IN_EFFECT                                = 0x2875,
    ...
    SMSG_LOSS_OF_CONTROL_AURA_UPDATE                                = 0x2699,
    SMSG_MAIL_COMMAND_RESULT                                        = 0x2659,
    SMSG_MAIL_LIST_RESULT                                           = 0x27A0,
    SMSG_MAIL_QUERY_NEXT_TIME_RESULT                                = 0x27A1,
    SMSG_MAP_OBJ_EVENTS                                             = 0x25D9,
    SMSG_MAP_OBJECTIVES_INIT                                        = 0x27A9,
    ...
    SMSG_MODIFY_CHARGE_RECOVERY_SPEED                               = 0x27B3,
    SMSG_MODIFY_COOLDOWN                                            = 0x27B1,
    SMSG_MODIFY_COOLDOWN_RECOVERY_SPEED                             = 0x27B2,
    ...
    SMSG_OPEN_SHIPMENT_NPC_FROM_GOSSIP                              = 0x27E5,
    SMSG_OPEN_SHIPMENT_NPC_RESULT                                   = 0x27E7,
    SMSG_OPEN_TRANSMOGRIFIER                                        = 0x283B,
    SMSG_OVERRIDE_LIGHT                                             = 0x26EE,
    SMSG_PAGE_TEXT                                                  = 0x2760,
    SMSG_PARTY_COMMAND_RESULT                                       = 0x27E2,
    SMSG_PARTY_INVITE                                               = 0x25CF,
    SMSG_PARTY_KILL_LOG                                             = 0x27A5,
    SMSG_PARTY_MEMBER_STATE                                         = 0x27A3,
    SMSG_PARTY_MEMBER_STATE_UPDATE                                  = 0x27A2,
    SMSG_PARTY_UPDATE                                               = 0x260B,
    SMSG_PAUSE_MIRROR_TIMER                                         = 0x2757,
    SMSG_PENDING_RAID_LOCK                                          = 0x2739,
    SMSG_PET_ACTION_FEEDBACK                                        = 0x2794,
    SMSG_PET_ACTION_SOUND                                           = 0x26CE,
    SMSG_PET_ADDED                                                  = 0x25A8,
    SMSG_PET_BATTLE_CHAT_RESTRICTED                                 = 0x2618,
    SMSG_PET_BATTLE_DEBUG_QUEUE_DUMP_RESPONSE                       = 0x26A0,
    ...
    SMSG_PLAYER_TABARD_VENDOR_ACTIVATE                              = 0x27A4,
    SMSG_POWER_UPDATE                                               = 0x2705,
    SMSG_PRE_RESURRECT                                              = 0x27B4,
    SMSG_PRELOAD_CHILD_MAP                                          = 0x2578,
    SMSG_PRINT_NOTIFICATION                                         = 0x25E1,
    SMSG_PROC_RESIST                                                = 0x27A6,
    ...
    SMSG_QUERY_ITEM_TEXT_RESPONSE                                   = 0x2811,
    ...
    SMSG_RAF_EMAIL_ENABLED_RESPONSE                                 = 0x27D3,
    SMSG_RAID_DIFFICULTY_SET                                        = 0x27F6,
    SMSG_RAID_GROUP_ONLY                                            = 0x27F8,
    ...
    SMSG_READ_ITEM_RESULT_FAILED                                    = 0x27F2,
    SMSG_READ_ITEM_RESULT_OK                                        = 0x27EC,
    SMSG_READY_CHECK_COMPLETED                                      = 0x260E,
    SMSG_READY_CHECK_RESPONSE                                       = 0x260D,
    SMSG_READY_CHECK_STARTED                                        = 0x260C,
    SMSG_REALM_LOOKUP_INFORMATION                                   = 0x2817,
    SMSG_REALM_QUERY_RESPONSE                                       = 0x26ED,
    SMSG_REATTACH_RESURRECT                                         = 0x2796,
    SMSG_RECRUIT_A_FRIEND_RESPONSE                                  = 0x27D4,
    ...
    SMSG_REMOVE_LOSS_OF_CONTROL                                     = 0x269B,
    SMSG_REPLACE_TROPHY_RESPONSE                                    = 0x280E,
    ...
    SMSG_SET_FORCED_REACTIONS                                       = 0x2763,
    SMSG_SET_ITEM_PURCHASE_DATA                                     = 0x25B0,
    SMSG_SET_LOOT_METHOD_FAILED                                     = 0x281D,
    ...
    SMSG_TRANSFER_ABORTED                                           = 0x2748,
    SMSG_TRANSFER_PENDING                                           = 0x25E5,
    SMSG_TRANSMOG_COLLECTION_UPDATE                                 = 0x25C6,
    SMSG_TRANSMOG_SET_COLLECTION_UPDATE                             = 0x25C7,
    SMSG_TRIGGER_CINEMATIC                                          = 0x2815,
    SMSG_TRIGGER_MOVIE                                              = 0x26FC,
    SMSG_TURN_IN_PETITION_RESULT                                    = 0x2799,
    SMSG_TUTORIAL_FLAGS                                             = 0x2807,
    SMSG_TUTORIAL_HIGHLIGHT_SPELL                                   = 0x2847,
    SMSG_TUTORIAL_UNHIGHLIGHT_SPELL                                 = 0x2846,
    SMSG_TWITTER_STATUS                                             = 0x2FFC,
    SMSG_UI_TIME                                                    = 0x275B,
    SMSG_UNDELETE_CHARACTER_RESPONSE                                = 0x2818,
    SMSG_UNDELETE_COOLDOWN_STATUS_RESPONSE                          = 0x2819,
    SMSG_UNLEARNED_SPELLS                                           = 0x2C4E,
    SMSG_UNLOAD_CHILD_MAP                                           = 0x2579,
    SMSG_UPDATE_ACCOUNT_DATA                                        = 0x2750,
    SMSG_UPDATE_CELESTIAL_BODY                                      = 0x2869,
    SMSG_UPDATE_CHARACTER_FLAGS                                     = 0x280D,
    SMSG_UPDATE_EXPANSION_LEVEL                                     = 0x2664,
    SMSG_UPDATE_GAME_TIME_STATE                                     = 0x2870,
    SMSG_UPDATE_INSTANCE_OWNERSHIP                                  = 0x26D7,
    SMSG_UPDATE_LAST_INSTANCE                                       = 0x26B6,
    SMSG_UPDATE_OBJECT                                              = 0x2816,
    SMSG_UPDATE_TALENT_DATA                                         = 0x25EC,
    SMSG_UPDATE_TASK_PROGRESS                                       = 0x27DB,
    SMSG_UPDATE_WEEKLY_SPELL_USAGE                                  = 0x2C19,
    SMSG_UPDATE_WORLD_STATE                                         = 0x2793,
    SMSG_USE_EQUIPMENT_SET_RESULT                                   = 0x279A,
    SMSG_USERLIST_ADD                                               = 0x2BB9,
    SMSG_USERLIST_REMOVE                                            = 0x2BBA,
    SMSG_USERLIST_UPDATE                                            = 0x2BBB,
    SMSG_VENDOR_INVENTORY                                           = 0x25CA,
    SMSG_VIGNETTE_UPDATE                                            = 0x27BB,
    SMSG_VOICE_CHANNEL_INFO_RESPONSE                                = 0x2868,
    SMSG_VOICE_LOGIN_RESPONSE                                       = 0x2867,
    ...
    SMSG_WARDEN3_DISABLED                                           = 0x286B,
    SMSG_WARDEN3_ENABLED                                            = 0x286A,
    SMSG_WARFRONT_COMPLETED                                         = 0x27AC,
    SMSG_WARGAME_REQUEST_SUCCESSFULLY_SENT_TO_OPPONENT              = 0x25B4,
    SMSG_WEATHER                                                    = 0x26D4,
    SMSG_WEEKLY_SPELL_USAGE                                         = 0x2C18,
    SMSG_WHO                                                        = 0x2BAE,
    SMSG_WHO_IS                                                     = 0x26D3,
    SMSG_WORLD_MAP_OPEN_NPC                                         = 0x2859,
    SMSG_WORLD_QUEST_UPDATE                                         = 0x284E,
    SMSG_WORLD_SERVER_INFO                                          = 0x25C2,
    SMSG_WOW_TOKEN_AUCTION_SOLD                                     = 0x2823,
    SMSG_WOW_TOKEN_BUY_REQUEST_CONFIRMATION                         = 0x2825,
    SMSG_WOW_TOKEN_BUY_RESULT_CONFIRMATION                          = 0x2826,
    SMSG_WOW_TOKEN_CAN_REDEEM_FOR_BALANCE_RESULT                    = 0x285C,
    SMSG_WOW_TOKEN_CAN_VETERAN_BUY_RESULT                           = 0x2824,
    SMSG_WOW_TOKEN_DISTRIBUTION_GLUE_UPDATE                         = 0x281E,
    SMSG_WOW_TOKEN_DISTRIBUTION_UPDATE                              = 0x281F,
    SMSG_WOW_TOKEN_MARKET_PRICE_RESPONSE                            = 0x2820,
    SMSG_WOW_TOKEN_REDEEM_GAME_TIME_UPDATED                         = 0x2827,
    SMSG_WOW_TOKEN_REDEEM_REQUEST_CONFIRMATION                      = 0x2828,
    SMSG_WOW_TOKEN_REDEEM_RESULT                                    = 0x2829,
    SMSG_WOW_TOKEN_SELL_REQUEST_CONFIRMATION                        = 0x2821,
    SMSG_WOW_TOKEN_SELL_RESULT_CONFIRMATION                         = 0x2822,
    SMSG_WOW_TOKEN_UPDATE_AUCTIONABLE_LIST_RESPONSE                 = 0x282A,
    SMSG_XP_GAIN_ABORTED                                            = 0x25E0,
    SMSG_XP_GAIN_ENABLED                                            = 0x27F7,
    ...
    SMSG_AZERITE_XP_GAIN                                            = 0xBADD,
    SMSG_DESTRUCTIBLE_BUILDING_DAMAGE                               = 0xBADD,
    SMSG_QUEST_POI_CHANGED                                          = 0xBADD,
    SMSG_QUEST_POI_QUERY_RESPONSE                                   = 0xBADD,
    SMSG_QUEST_SPAWN_TRACKING_UPDATE                                = 0xBADD,
